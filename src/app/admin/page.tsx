  ...
  return (
    <div className="min-h-screen bg-graphite flex items-center justify-center p-4">
      <motion.div
        ...
        className="w-full max-w-md bg-graphite-light rounded-2xl p-8 border border-metal-gray/20"
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-display font-bold text-white mb-2">
            Admin Panel
          </h1>
          <p className="text-metal-gray">Soluciones Integrales JS</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm text-metal-gray mb-2">Usuario</label>
            <input
              type="text"
              value={username}
              onChange={(e) => setUsername(e.target.value)}
              className="w-full px-4 py-3 bg-graphite border border-metal-gray/30 rounded-lg text-white focus:border-industrial-blue focus:outline-none transition-colors"
              required
            />
          </div>

          <div>
            <label className="block text-sm text-metal-gray mb-2">Contraseña</label>
            <input
              type="password"
              value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-industrial-blue hover:bg-industrial-blue-light text-white rounded-lg font-medium transition-colors disabled:opacity-50"
          >
